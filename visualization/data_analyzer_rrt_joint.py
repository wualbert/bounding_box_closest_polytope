...
# plt.close()
percent_x = np.linspace(100, 10000, 50)
...
# plt.legend(['Hopper', 'Pendulum', '5%', '10%'])
plt.xlabel('Number of Polytopes')
plt.ylabel('Number of Polytopes Evaluated')
# plt.yscale('log')
plt.xscale('log')
# plt.ylim(bottom=0, top=0.02)
plt.title('AABB Median Evaluated Polytopes on R3T Datasets')
plt.tight_layout()
...
# plt.xscale('log')
# plt.ylim(bottom=0, top=0.02)
plt.title('AABB Max Evaluated Polytopes on R3T Datasets')
