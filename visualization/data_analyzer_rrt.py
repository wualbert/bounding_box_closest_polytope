...
# Load
dir = '/Users/albertwu/Google Drive/MIT/RobotLocomotion/Closest Polytope/ACC2020/Results/RRT/pendulum'#os.path.dirname(os.path.realpath(__file__))+'/../tests/test_random_zonotope_dim20190919_01-56-56'
...
plt.yscale('log')
plt.title('Querying Test on Pendulum')
