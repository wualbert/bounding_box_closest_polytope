...
# Load
dir = '/Users/albertwu/exp/closest_polytope/tests/test_on_rrt20190924_13-14-53'#os.path.dirname(os.path.realpath(__file__))+'/../tests/test_random_zonotope_dim20190919_01-56-56'
...
plt.errorbar(polytope_counts, aabb_precomputation_times_median, marker='.', color='r', linewidth=0.5, markersize=7)
...
plt.title('Nearest Polytope Single Query Time vs. Number of Polytopes')
